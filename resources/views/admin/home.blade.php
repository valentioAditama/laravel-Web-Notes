                                ...
                                <div class="overflow-auto md:overflow-scroll">
                                    <table class="table-fixed">
                                        <thead>
                                            <tr>
                                                <th
                                                    class="w-1/12 border border-5 bg-gray-100 p-3 font-sans font-semibold">
                                                    No</th>
                                                <th
                                                    class="w-1/12 border border-5 bg-gray-100 p-3 font-sans font-semibold">
                                                    Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="border border-5 font-sans font-normal p-3">{{ $row->id }}
                                                </td>
                                                <td class="border border-5 font-sans font-normal p-3">{{ $row->name }}
                                                </td>
                                                <td class="border border-5 font-sans font-normal p-3">{{ $row->notes }}
                                                </td>
